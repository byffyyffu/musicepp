...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("**✅ تم اعاده تشغيل موسيقى ايثون**")
...
⧉ | لتشغيل صوتية في المكالمة أرسل ⇦ [ `{HNDLR}بحث  + اسم الاغنية` ]
⧉ | لتشغيل فيديو في المكالمة  ⇦ [ `{HNDLR}بحث_فيديو  + اسم الاغنية` ]
———————×———————
